...
function HomePage(props) {
  ...
  return (
    <div>
      <Button color="danger" className="d-block m-5">
      ...
      <button onClick={notify2} className="btn btn-warning">
        Warning !
      </button>
      <button onClick={notify3} className="btn btn-danger">
        Error !
      </button>
      <button onClick={notify4} className="btn btn-primary">
        Info !
      </button>
    </div>
  );
